        ...
        <>
            {data?.map((item) => {
                ...
                return <tr key={item.id} className="even:bg-gray-50 hover:bg-gray-100">
                    ...
                    <td className="py-2 px-4 border-b text-[12px] text-center">
                        <img src={`https://police-shaheed.vercel.app/profiles/${item.photo}`} className="w-[96px] " alt={name} />
                    </td>
                    <td className="py-2 px-4 border-b text-[15px] text-center">
                        ...
                        {/* edit Form Start */}
                        <div className={`${formDis === false ? "hidden static" : "fixed block"} top-0 left-0 w-full h-screen overflow-y-auto bg-white`}>
                            <div className="flex items-center justify-center w-full min-h-screen">
                                ...
                                <form onSubmit={handleSubmit} className="w-[80%] flex items-center justify-start min-h-screen py-5 pt-10 px-5 flex-col">
                                    ...
                                    <div className="flex items-center justify-between w-full my-5">
                                        ...
                                        <div className="flex flex-col w-[calc(100%/2.10)]">
                                            <label className="ml-5 text-start">Place of Posting</label>
                                    ...
                                    <div className="flex items-center justify-between w-full my-5">
                                        ...
                                        <div className="flex flex-col w-[calc(100%/2.10)]">
                                            <label className="ml-5 text-start">Date of Appointment</label>
                                    ...
                                    <div className="flex items-center justify-between w-full my-5">
                                        <div className="flex flex-col w-[calc(100%/2.10)]">
                                            <label className="ml-5 text-start">Date of Shahadat</label>
                                    ...
                                    <div className="flex items-center justify-between w-full my-5">
                                        <div className="flex flex-col w-full">
                                            <label className="ml-5 text-start">Police Station</label>
                                    ...
                                    <div className="flex items-center justify-between w-full my-5">
                                        <div className="flex flex-col w-[calc(100%/2.10)]">
                                            <label className="ml-5 text-start">Compensation Amount</label>
                                    ...
                                    <div className="flex items-center justify-between w-full my-5">
                                        <div className="flex items-center gap-5">
                                            ...
                                            <img src={`https://police-shaheed.vercel.app/profiles/${item.photo}`} className="w-[96px]" alt="" />
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-center w-full gap-5 my-5">
                                        ...
                                        }} type="button" className="w-full px-4 py-3 mt-3 text-xl font-bold text-white bg-red-500 rounded hover:bg-red-700 sm:mt-0 sm:ml-3">
                                            Cancel
                                        </button>
